...
class SyncAuthUserV1 {
  ...
  @override
  String toString() => 'SyncAuthUserV1[hasProfileImage=$hasProfileImage, id=$id, isAdmin=$isAdmin, oauthId=$oauthId, pinCode=$pinCode, profileChangedAt=$profileChangedAt, quotaSizeInBytes=$quotaSizeInBytes, quotaUsageInBytes=$quotaUsageInBytes, storageLabel=$storageLabel]';
